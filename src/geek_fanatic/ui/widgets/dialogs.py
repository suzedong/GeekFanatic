...
class FileDialogs:
    ...
    def get_open_file_name(
        ...
        """显示打开文件对话框"""
        file_name, _ = QFileDialog.getOpenFileName(parent, caption, directory, filter)
    ...
    def get_save_file_name(
        ...
        """显示保存文件对话框"""
        file_name, _ = QFileDialog.getSaveFileName(parent, caption, directory, filter)
        return file_name if file_name else None
...
class FindReplaceDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.find_next_btn = button_box.addButton(
            "查找下一个", QDialogButtonBox.ActionRole
        )
        self.replace_btn = button_box.addButton("替换", QDialogButtonBox.ActionRole)
        self.replace_all_btn = button_box.addButton(
            "全部替换", QDialogButtonBox.ActionRole
        )
